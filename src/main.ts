...
const socket       = new SocketService(localConfig);
...
const control      = new ControlService(socket, remoteConfig, log);
const state        = new StateService(socket, remoteConfig, control, video, audio, log, command);
new TelemetryService(socket, state);
